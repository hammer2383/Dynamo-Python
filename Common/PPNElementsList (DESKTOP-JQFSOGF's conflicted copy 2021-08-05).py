...
class FilterTool(object):
    ...
    """     
    def __init__(self):
        """USESTR(bool, evil): only use in paramvalue function. True to set function to read string value.
        """
        self.USESTR = False # dictaate function paramvalue whethever to return all value as AsValueString   
